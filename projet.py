...
n = 100
df20 = pd.read_csv("2020.csv", sep=',', error_bad_lines=False,header=0, skiprows=lambda i: i % n != 0, low_memory=False)
df20['date_mutation']=pd.to_datetime(df20["date_mutation"])
df19 = pd.read_csv("2019.csv", sep=',', error_bad_lines=False,header=0, skiprows=lambda i: i % n != 0, low_memory=False)
df19['date_mutation']=pd.to_datetime(df19["date_mutation"])
df18 = pd.read_csv("2018.csv", sep=',', error_bad_lines=False,header=0, skiprows=lambda i: i % n != 0, low_memory=False)
df18['date_mutation']=pd.to_datetime(df18["date_mutation"])
df17 = pd.read_csv("2017.csv", sep=',', error_bad_lines=False,header=0, skiprows=lambda i: i % n != 0, low_memory=False)
df17['date_mutation']=pd.to_datetime(df17["date_mutation"])
df16 = pd.read_csv("2016.csv", sep=',', error_bad_lines=False,header=0, skiprows=lambda i: i % n != 0, low_memory=False)
